# CigarOdyssey — journal des chantiers

Le récit de chaque chantier terminé, dans l'ordre où il a été mené.
La feuille de route active — ce qui reste à faire — est dans
`docs/roadmap.md`.

---

# Détail des chantiers cochés (sections A → R)

## A. Sécurité & robustesse

### **A4** — L'adresse du visiteur ne se déclare plus soi-même
...
### **B4a** — Le contenu de l'atlas entre dans le dépôt
...
### **B4b1** — Sauvegarde de ce que Git ne portera jamais
...
### **B5a** — Le droit à l'effacement (RGPD art. 17)
...
### **B5b** — Mentions légales, confidentialité, conditions *(partiel — voir B5c)*
...
### **B5c** — Les faits que seul l'éditeur connaît
...
### **B6** — HSTS, et les fichiers qui protègent la production
...
### **B9** — La chaîne email éprouvée pour de bon
...
### **B3** — Nom & domaine unifiés (CigarOdyssey / cigarodyssey.com) · *débloque A2*
...
### **B8** — Le domaine acheté : `thecigarodyssey.com`
...
### **C1c** — Cache-busting des fichiers statiques
...
### **D32** — Une cape n'est pas une marque · migration `023`
...
### **D36** — Trois pays producteurs de plus, et trois écartés · migration `027`
...
### **D35** — Relecture sur sources : quatre erreurs, six précisions · migration `026`
...
### **D34** — Douze maisons de plus, et une erreur d'inventaire réparée · migration `025`
...
### **D33** — Vingt-cinq maisons que l'atlas ignorait · migration `024`
...
### **D31** — Les marques qui manquaient à l'atlas · migration `022`
...
### **D30** — Onze marques que rien ne reliait au site · migration `021`
...
### **D29** — Deux parcours qui ne mesuraient plus rien
...
### **D27** — Référencement des discussions
...
### **D26** — Suivre un sujet, et apprendre qu'on a reçu une réponse · migration `020`
...
### **D25** — Activité récente et ancrage sur l'atlas
...
### **D24** — Deux détails de l'espace communautaire
...
### **D23** — Les langues s'ouvrent et se ferment depuis l'administration · migration `019`
...
### **D22** — Photos dans les messages de la communauté
...
### **D21** — Bouton de rotation automatique du globe
...
### **D19** — Portail d'âge à l'arrivée (18 ans)
...
### **D20** — Communauté : les deux points d'entrée à la charte, et le menu mobile
...
### **E1c** — Espace communautaire, **V1 : les discussions**
...
### **E1d** — Espace communautaire, **V2 : les événements**
...
### **E1e** — Espace communautaire, **V3 : le modérateur**
...
### **D16** — Zoom : double-tape sur le globe, plus nulle part ailleurs
...
### **D17** — Partager une marque comme un article
...
### **D18** — Le partage, pour de vrai sur téléphone
...
### **E5** — `action=all` ne servait que le globe
...
### **D15** — Globe figé sur mobile après fermeture d'un panneau
...
### **D13** — L'approbation crée un vrai établissement, et prévient l'auteur · migration 013
...
### **D14** — L'email d'approbation dans la langue de l'utilisateur · migration 014
...
### **D8** — Position sur place dans « Signaler un établissement » · migration 011
...
### **D9** — Drapeaux animés : 4 défauts corrigés
...
### **D10** — Fiche pratique du pays : devise, langue, heure + fuseau, distance
...
### **D12** — Itinéraire et distance sur chaque fiche d'établissement · migration 012
...
### **D11** — Rebond du marqueur sélectionné
...
### **D7** — Fête nationale : bannière et confettis au clic sur un pays, le jour dit
...
### **F4b** — Prose longue **100 %** (4 545 / 4 545) · export à zéro
...
### **E5** — Les copies figées du contenu, embarquées dans le front
...
### **E6** — Rien ne relie une traduction à la version du français dont elle est issue
...
### **R0** — Reboucler l'audit géométrique + en faire un outil
...
### **R1** — Les 21 valeurs chiffrées des fiches pays · migration `028`
...
### **R2** — Les valeurs des fiches pratiques · migration `029` · `tools/geo_banquemondiale.php`
...
### **R4** — Les zones de production · migration `030`
...
### **R5** — La prose des fiches · migration `031` · `tools/coherence_check.php`
...
### **R2 bis** — Les 45 valeurs que R2 avait écartées · migration `032`
...
### **R2 ter** — Les 78 autres pays de `data.pays.js` · `coherence_check.php`
...
### **R1 bis** — Les revenus manquants · migrations `033`, `034`
...
### **R1 ter** — Le tiret devient une phrase · `panels.js`, `components.css`
...
### **R1 quater** — Les États-Unis, et le critère appliqué à tous · migration `035`
...
### **R1 quinquies** — Un revenu pour quatorze pays sur quinze · migration `036`
