...
CREATE TABLE `feuilles` (
  ...
  `source` text COLLATE utf8mb4_unicode_ci COMMENT 'D''où vient la fiche (229). Texte libre, comme brands.source.',
...
CREATE TABLE `lounges` (
  ...
  `lon` decimal(10,7) DEFAULT NULL,
  `contribution_id` int unsigned DEFAULT NULL COMMENT 'Contribution a l origine de cette fiche, si communautaire',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_country_name` (`country_id`,`name`(191)),
  UNIQUE KEY `uq_contribution` (`contribution_id`),
  KEY `idx_country` (`country_id`),
...
CREATE TABLE `producer_countries` (
  ...
  `revenue` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rev_detail` text COLLATE utf8mb4_unicode_ci,
  ...
  `rev_detail_en` text COLLATE utf8mb4_unicode_ci,
  `rev_detail_es` text COLLATE utf8mb4_unicode_ci,
  `rev_detail_de` text COLLATE utf8mb4_unicode_ci,
  `rev_detail_zh` text COLLATE utf8mb4_unicode_ci,
  `rev_detail_ar` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `producer_geo` (
  ...
  `currency_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_es` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_zh` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_ar` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_es` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_de` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_zh` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language_ar` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `independent_en` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `independent_es` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `independent_de` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `independent_zh` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `independent_ar` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`country_id`),
